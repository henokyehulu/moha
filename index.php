                        ...
                        <div class="header-wrap">
                            ...
                            <nav class="header-menu" data-content="mainNav">
                                <ul class="menu-list ms-lg-auto">
                                    <li class="menu-item"><a href="/moha/#home" class="menu-link nav-link">Home</a></li>
                                    <li class="menu-item"><a href="/moha/#feature" class="menu-link nav-link">Features</a></li>
                                    <li class="menu-item"><a href="/moha/#previews" class="menu-link nav-link">Previews</a></li>
                                    <li class="menu-item"><a href="/moha/#reviews" class="menu-link nav-link">Reviews</a></li>
                                </ul>
                                <ul class="menu-btns">
                                    <li>
                                        <a href="/moha/login.php" class="btn btn-primary btn-lg">Login</a>
                                    </li>
                                </ul>
                            </nav><!-- .nk-nav-menu -->
                        </div><!-- .header-warp-->
                        ...
                        <div class="row flex-lg-row-reverse align-items-center justify-content-between g-gs">
                            ...
                            <div class="col-lg-5 col-md-10">
                                <div class="header-caption">
                                    <h1 class="header-title fw-medium">WELCOME TO MOHA SOFT DRINKS INDUSTRY</h1>
                                    <div class="header-text">
                                        <p>Powerful dashboard template that especially build for developers and programmers. DashLite comes with all kind of components.</p>
                                    </div>
                                    <ul class="header-action btns-inline">
                                        <li><a href="#" class="btn btn-danger btn-lg"><span>Get Started</span></a></li>
                                        <li><a class="link link-block link-primary popup-video" href="https://www.youtube.com/watch?v=SSo_EIwHSd4"><em class="icon icon-lg ni ni-play-circle"></em><span>Watch video</span></a></li>
                                    </ul>
                                </div><!-- .header-caption -->
                            </div><!-- .col -->
                        </div><!-- .row -->
	...
	h44.3c13.5,0,24.5-10.7,25-24.1H487c13.8,0,25-11.2,25-25V217.8C512,204,500.8,192.8,487,192.8z" />
            ...
            <footer class="footer">
                        ...
                        <div class="col-xl-2 col-lg-3 col-md-8">
                            <div class="widget">
                                ...
                                <ul class="widget-contact row gx-gs">
                                    <li class="col-mb-6 col-lg-12"><em class="icon ni ni-map-pin-fill"></em><span> 31 Mirpur Street <br />Dhaka, Bangladesh</span></li>
                                    <li class="col-mb-6 col-lg-12"><em class="icon ni ni-call-fill"></em><span>(021) 5248 631 <br />(021) 5148 6324</span></li>
                                </ul>
                            </div>
                        </div><!-- .col -->
                    </div><!-- .row -->
                ...
                <div class="bg-dark text-center is-dark py-3">
                    <div class="container">
                        <div class="text-base"> &copy; 2023, dashlite. Template made by <a href="https://softnio.com" target="_blank">Softnio</a></div>
                    </div>
                </div>
            </footer><!-- .footer -->
        </div>
