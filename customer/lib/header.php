                        ...
                        <div class="dropdown-menu dropdown-menu-xl dropdown-menu-end">
                            ...
                            if (!empty($products_in_cart)) { ?>
                                <div class="dropdown-foot center">
                                    <a href="/moha/customer/cart.php">View All</a>
                                </div>
                            <?php }
                            ?>
                    ...
                    <li class="dropdown user-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end">
                            ...
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    <li><a href="/moha/customer/profile.php"><em class="icon ni ni-user-alt"></em><span>View Profile</span></a></li>
                                    <li><a href="/moha/customer/security.php"><em class="icon ni ni-setting-alt"></em><span>Account Setting</span></a></li>
                                </ul>
                            </div>
                            <div class="dropdown-inner">
                                <ul class="link-list">
