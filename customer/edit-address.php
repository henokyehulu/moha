...
$form_data = [
    'state' => $_POST['state'] ?? $customer['state'],
    'address_1' => $_POST['address_1'] ?? $customer['address_1'],
    'address_2' => $_POST['address_2'] ?? $customer['address_2'],
    'id' => $customer['id']
];
                                                ...
                                                <div class="nk-block-head nk-block-head-lg">
                                                    <div class="nk-block-between">
                                                        <div class="nk-block-head-content">
                                                            <a href="/moha/customer/profile.php" class="btn mb-3 btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a>
                                                                    ...
                                                                    <div class="form-control-wrap">
                                                                        <select name="state" class="form-select js-select2" required>
                                                                            ...
                                                                            foreach ($states as $state) { ?>
                                                                                <option <?php if ($customer['state'] == $state['id']) { ?> selected <?php } ?> value="<?php echo $state['id'] ?>">
