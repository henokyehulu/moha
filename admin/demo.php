...
<head>
    ...
    <link rel="shortcut icon" href="/moha/images/moha.png">
    <title>Login</title>
                                            ...
                                            <div class="slider-item">
                                                <div class="nk-feature nk-feature-center">
                                                    ...
                                                    <div class="nk-feature-content py-4 p-sm-5">
                                                        <img src="uploadad/<?php echo $row->image; ?>" class="rounded mx-auto d-block " alt="ad_img" style="width:600px; height:500px;">
