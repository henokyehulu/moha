                    ...
                    <li class="dropdown user-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end">
                            ...
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    <li><a href="/moha/admin/profile.php"><em class="icon ni ni-user-alt"></em><span>View Profile</span></a></li>
                                    <li><a href="/moha/admin/security.php"><em class="icon ni ni-setting-alt"></em><span>Account Setting</span></a></li>
                                </ul>
                            </div>
                            <div class="dropdown-inner">
                                <ul class="link-list">
