...
$stmt = $pdo->prepare("SELECT * FROM  admin_store");
$stmt->execute();
...
if (isset($_POST["addproduct"])) {
  ...
  if ($stmt->rowCount() === 0) {
    ...
    $stmt = $pdo->prepare("INSERT INTO admin_store(name)VALUES(:Pname)");
    $stmt->execute([
      'Pname' => $Pname,
                        ...
                        <?php foreach ($products as $product) : ?>
                          ...
                          <div class="nk-tb-item">
                            ...
                            <form method="post" class="nk-tb-col nk-tb-col-tools">
                              ...
                              <a href="./admin/addtostore.php?add=<?= $product['id']; ?>" class="btn btn-primary mt-3">Add to Store</a>
