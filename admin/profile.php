                                                    ...
                                                    <div class="nk-data data-list">
                                                        ...
                                                        <div class="data-item" data-bs-toggle="modal" data-bs-target="#profile-edit">
                                                            <div class="data-col">
                                                                ...
                                                                <span class="data-value"><?php echo $admin['name'] ?></span>
                                                            </div>
                                                            <div class="data-col data-col-end"><a href="/moha/admin/edit-profile.php" class="data-more"><em class="icon ni ni-forward-ios"></em></a></div>
                                                        </div><!-- data-item -->
                                                        <div class="data-item" data-bs-toggle="modal" data-bs-target="#profile-edit">
                                                            <div class="data-col">
                                                                <span class="data-label">Email</span>
                                                                <span class="data-value text-soft"><?php echo $admin['email'] ?? "Not added yet ," ?> </span>
                                                            </div>
                                                            <div class="data-col data-col-end"><a href="/moha/admin/edit-profile.php" class="data-more"><em class="icon ni ni-forward-ios"></em></a></div>
                                                        </div><!-- data-item -->
                                                        <div class="data-item" data-bs-toggle="modal" data-bs-target="#profile-edit">
                                                            <div class="data-col">
                                                                ...
                                                                <span class="data-value text-soft"><?php echo $admin['phone_number'] ?></span>
                                                            </div>
                                                            <div class="data-col data-col-end"><a href="/moha/admin/edit-profile.php" class="data-more"><em class="icon ni ni-forward-ios"></em></a></div>
                                                        </div><!-- data-item -->
                                                        <div class="data-item" data-bs-toggle="modal" data-bs-target="#profile-edit" data-tab-target="#address">
                                                            <div class="data-col">
                                                                ...
                                                                <span>
                                                                    <?php echo  ucwords($admin['state_name']) ?>, Addis Ababa,<br />
                                                                    <?php echo $admin['address_1'] ?? "Address 1 not added yet ," ?> <br />
                                                                </span>
                                                                <span>
                                                                    <span></span>

                                                            </div>
                                                            <div class="data-col data-col-end"><a href="/moha/admin/edit-address.php" class="data-more"><em class="icon ni ni-forward-ios"></em></a></div>
                                                        </div><!-- data-item -->
                                                    </div>
                                                </div><!-- .nk-block -->
                                            </div>
