...
$form_data = [
    'state' => $_POST['state'] ?? $agent['state'],
    'address_1' => $_POST['address_1'] ?? $agent['address_1'],
    'address_2' => $_POST['address_2'] ?? $agent['address_2'],
    'id' => $agent['id']
];
                                                                    ...
                                                                    <div class="form-control-wrap">
                                                                        <select name="state" class="form-select js-select2" required>
                                                                            ...
                                                                            foreach ($states as $state) { ?>
                                                                                <option <?php if ($agent['state'] == $state['id']) { ?> selected <?php } ?> value="<?php echo $state['id'] ?>">
