...
if (isset($_POST['save'])) {
    if ($agent['password'] !== $form_data['old_password']) {
...
<body>
    ...
    <?php ?>
    <form method="post">
        <input type="password" name="old_password" value="<?php echo $form_data['old_password'] ?>" placeholder="Old password" required />
        <input type="password" name="new_password" value="<?php echo $form_data['new_password'] ?>" placeholder="New password" required />
