                                ...
                                <div class="nk-block-between g-3">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des text-soft">
                                            <p>You have total 937 Transaction.</p>
                                        </div>
                                        ...
                                        <div class="card-inner">
                                            <div class="card-title-group">
                                                <div class="card-title">
                                                    <h5 class="title">All Transaction</h5>
                                                </div>
                                                ...
                                                <tbody class="tb-odr-body">
                                                    <tr class="tb-odr-item">
                                                        <td class="tb-odr-info">
                                                            <span class="tb-odr-id"><a href="agent/invoice-details.php">#746F5K2</a></span>
                                                        ...
                                                        <td class="tb-odr-action">
                                                            <div class="tb-odr-btns d-none d-sm-inline">
                                                                <a href="agent/invoice-print.php" target="_blank" class="btn btn-icon btn-white btn-dim btn-sm btn-primary"><em class="icon ni ni-printer-fill"></em></a>
                                                                <a href="agent/invoice-details.php" class="btn btn-dim btn-sm btn-primary">View</a>
                                                            </div>
                                                            <a href="agent/invoice-details.php" class="btn btn-pd-auto d-sm-none"><em class="icon ni ni-chevron-right"></em></a>
                                                        </td>
                                                    </tr><!-- .tb-odr-item -->
                                                    <tr class="tb-odr-item">
                                                        <td class="tb-odr-info">
                                                            <span class="tb-odr-id"><a href="agent/invoice-details.php">#546H74W</a></span>
                                                    ...
                                                    <tr class="tb-odr-item">
                                                        <td class="tb-odr-info">
                                                            <span class="tb-odr-id"><a href="agent/invoice-details.php">#87X6A44</a></span>
                                                    ...
                                                    <tr class="tb-odr-item">
                                                        <td class="tb-odr-info">
                                                            <span class="tb-odr-id"><a href="agent/invoice-details.php">#986G531</a></span>
                                                    ...
                                                    <tr class="tb-odr-item">
                                                        <td class="tb-odr-info">
                                                            <span class="tb-odr-id"><a href="agent/invoice-details.php">#326T4M9</a></span>
                                                            <span class="tb-odr-date">21 Jan 2019, 6 :12 am</span>
                                                        </td>
                                                        <td class="tb-odr-amount">
                                                            <span class="tb-odr-total">
