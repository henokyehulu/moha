...
if (isset($_POST['remove_product'])) {
    ...
    header("location:/moha/agent/cart.php");
}
...
<body>
    <a href="/moha/agent/order.php">back</a>
    <table border="1">
        <thead>
            <td>Product</td>
                    ...
                    <tr>
                        ...
                        <td class="creats">
                            <form method="post">
                                ...
                                <input type="number" name="creat" value="<?php echo $products_in_cart[$product['id']] ?>" min="1" required />
    ...
    <a href="/moha/agent/checkout.php">checkout</a>
</body>
