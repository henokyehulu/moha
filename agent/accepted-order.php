                        ...
                        <div class="nk-content-body">
                            <div class="nk-block-head nk-block-head-sm">
                                <div class="nk-block-between">
                                    ...
                                    <div class="nk-block-head-content">
                                        <a href="/moha/agent/cutomer-order-list.php" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a>
                                        <a href="/moha/agent/cutomer-order-list.php" class="btn btn-icon btn-outline-light bg-white d-inline-flex d-sm-none"><em class="icon ni ni-arrow-left"></em></a>
                                    </div>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="price">
                                                                            <form method="post">
                                                                                ...
                                                                                <button name="deliver_order" type="submit" class="btn btn-primary mt-3">Mark as deliver</button>
                                                                            </form>
                                                                        </td>
                                                                    </tr>
                                                                <?php endforeach; ?>
